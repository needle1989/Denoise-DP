function R = EBSBL_BO(Phi, y, Len, noiseFlag, varargin)
...
%         lambda = coef * (norm(y - A * mu_x,2)^2/N + lambdaComp/N);
        lambda = norm(y - A * mu_x,2)^2/N + coef * lambdaComp/N;
...
%     Dictionary = Dictionary + (blkMatrix - Dictionary * x) * x.'
